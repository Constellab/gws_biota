...
from peewee import CharField, FloatField, TextField, ForeignKeyField
...
class Compound(Entity):
    ...
    ontology = ForeignKeyField(ChebiOntology, backref = 'compounds', null = True)
    ...
    def create_compound_db(cls, biodata_dir = None, **kwargs):
        ...
        for comp in compounds:
            try:
                comp.ontology = ChebiOntology.get(ChebiOntology.chebi_id == comp.chebi_id)
            except:
                pass
