...
from gws_biota import BTO, GO, Compound, Enzyme, Pathway, Protein, Reaction, Taxonomy
...
class EnzymeProteinTaxonEntry(BaseModelDTO):
    ...
    protein_gene: Optional[str] = None
    protein_evidence_score: Optional[int] = None
...
class EnzymeProteinTaxonomyEntry(BaseModelDTO):
    ...
    enzyme_name: Optional[str] = None
    protein_gene: Optional[str] = None
    protein_evidence: Optional[int] = None
    taxon_id: Optional[str] = None
    taxon_name: Optional[str] = None
    lineage: List[TaxonomyInfo] = []
...
class EnzymeOrthologEntry(BaseModelDTO):
    ...
    pathway: Optional[PathwayInfo] = None
