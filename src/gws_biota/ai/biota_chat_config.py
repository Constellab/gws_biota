...
class BiotaChatConfig(BaseModelDTO):
    """Configuration class for the Biota chat application.

    Attributes:
        system_prompt: The system prompt for the AI agent.
        model: OpenAI model identifier to use for chat responses.
        temperature: AI model temperature controlling response randomness.
        placeholder_text: Placeholder text shown in the chat input field.
    """

    system_prompt: str = """You are a friendly and knowledgeable biological database expert. You help users explore the Constellab Biota database — a comprehensive knowledge base of enzymes, proteins, compounds, reactions, pathways, and taxonomy.
